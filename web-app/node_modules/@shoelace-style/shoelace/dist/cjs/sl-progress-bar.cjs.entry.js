...
const ProgressBar = class {
  ...
  render() {
    return (index.h("div", { part: "base", class: {
      ...
      }, role: "progressbar", "aria-valuemin": "0", "aria-valuemax": "100", "aria-valuenow": this.indeterminate ? null : this.percentage }, index.h("div", { part: "indicator", class: "progress-bar__indicator", style: {
        width: `${this.percentage}%`
      } }, !this.indeterminate && (index.h("span", { part: "label", class: "progress-bar__label" }, index.h("slot", null))))));
  }
};
