...
const Menu = class {
  constructor(hostRef) {
    ...
    this.slSelect = index.createEvent(this, "sl-select", 7);
  ...
  render() {
    return (index.h("div", { ref: el => (this.menu = el), part: "base", class: "menu", role: "menu", onClick: this.handleClick, onKeyDown: this.handleKeyDown, tabIndex: 0 }, index.h("slot", null)));
  }
